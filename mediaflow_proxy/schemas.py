...
class ExtractorURLParams(GenericParams):
    host: Literal[
        "Doodstream", "FileLions", "FileMoon", "F16Px", "Mixdrop", "Uqload", "Streamtape", "StreamWish", "Supervideo", "VixCloud", "Okru", "Maxstream", "LiveTV", "LuluStream", "DLHD", "Fastream", "VidGuard", "TurboVidPlay", "Vidmoly", "Vidoza", "Voe", "VK", "Sportsonline"
