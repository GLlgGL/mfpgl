...
class ExtractorURLParams(GenericParams):
    host: Literal[
        "Doodstream", "FileLions", "FileMoon", "Mixdrop", "Uqload", "Streamtape", "StreamWish", "Supervideo", "VixCloud", "Okru", "Maxstream", "LiveTV", "LuluStream", "DLHD", "Fastream", "VidGuard", "TurboVidPlay", "Vidmoly", "Vidoza", "Voe", "Sportsonline"
